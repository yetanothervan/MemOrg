...
{
    class BlockRelation : Block
    {
        public BlockRelation(IDrawStyle style, IGridElem gridElem) : base(style, gridElem)
        {
        }
        ...
        public override List<DrawingVisual> Render(Point p)
        {
            ...
            using (var dc = dv.RenderOpen())
            {
                ...
                dc.DrawRectangle(Style.RelationBlockBrush, Style.RelationBlockPen, rect);
            }
            result.Add(dv);
