...
namespace GraphViewer
{
    ...
    {
        public ContentViewModel(IGraphOrganizeService graphOrganizeService, IGraphDrawService graphDrawService, IGraphVizulaizeService graphVizulaizeService)
        {
            ...
            Grid = graphVizulaizeService.VisualizeGrid(grid, drawer);
        }
